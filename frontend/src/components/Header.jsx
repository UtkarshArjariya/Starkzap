...
export default function Header() {
  ...
  return (
    <header
      ...
      className="sticky top-0 z-50 border-b border-white/10 bg-[#0F0F0F]/80 backdrop-blur-md"
    >
...
function WalletButton({ wallet, connecting, onConnect, onDisconnect }) {
  if (wallet) {
    return (
  ...
  return (
    <button
      onClick={onConnect}
      disabled={connecting}
      className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 disabled:opacity-60 text-white px-4 py-1.5 rounded-lg text-sm font-medium transition-colors"
